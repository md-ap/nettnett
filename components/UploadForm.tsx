...
export default function UploadForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-lg border border-white/10 bg-white/[0.02] p-6">
      ...
      <div className="mt-6 flex items-center gap-3 rounded border border-white/10 bg-white/[0.03] px-4 py-3">
        <input
          type="checkbox"
          id="uploadToIA"
          checked={uploadToIA}
      ...
      {!uploading && (
        <button
          ...
          className="mt-6 w-full rounded bg-white py-3 font-semibold text-black transition-opacity hover:opacity-90 disabled:opacity-30"
        >
